...
# Run base-learners with synthetic data generation by a Synthetic Minority Oversampling TEchnique (SMOTE) during resampling
...
#  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
# ===============================================================================================================================================================================
# Run SMOTE synthetic data generation routine embedded in cross-validation
# ===============================================================================================================================================================================
#  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
# ===============================================================================================================================================================================
...
smotest <- list(name = "SMOTE",
                func = function (x, y) {
                  ...
                  dat$HRT.use<-round(dat$HRT.use,0)
                  dat$OCP.use<-round(dat$OCP.use,0)
                  dat$Diabetes<-round(dat$Diabetes,0)
...
control <- trainControl(method="repeatedcv", number=10,repeats=5,savePredictions=TRUE, classProbs=TRUE,
                        summaryFunction = twoClassSummary,search = "random",allowParallel = TRUE,sampling=smotest,# sampling with SMOTE algorithm
...
save(list=c("trainAlgo"),file=paste0('./Results_WithCVandSMOTESampling_JoinedTimeGroup_',tg,'_',algo,'.Rdata'))
